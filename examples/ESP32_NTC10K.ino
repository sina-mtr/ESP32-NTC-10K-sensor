...
//fist prm is pin number, second prm is show thermistor is R1 or R2 in voltage devider formula
//if with increasing temp, temp number decreased, change it to false.
